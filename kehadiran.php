...
$sql0 = "SELECT id FROM kehadiran WHERE trim(upper(nama))=trim(upper('". $nama ."'))  LIMIT 1";
...
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()) {
	 ...
	 $sql = "INSERT INTO kehadiran (nama, keluarga, souvenir, total) VALUES ('".$nama."', '".$undangan."', 'Belum', '".$total."') ";
