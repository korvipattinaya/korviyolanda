...
$sql = "SELECT * FROM kehadiranjogja order by kerabat, nama  ";
$stmt = $db->prepare($sql);
$stmt->execute();
$result = $stmt->fetchAll();

$sql1 = "Select sum(a.total) total, sum(a.gift) souvenir from ( SELECT count(*) total, 0 gift FROM kehadiranjogja union all select 0 total , count(*) gift from kehadiranjogja where souvenir = 'Sudah') a";
...
if(isset($_POST['ambil'])){
    ...
    if($saved) header("Location: listinvitationjogja.php");
}
?>
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<div id="fh5co-couple-story">
		<div class="container">
            ...
            <div class="card mb-3">
				<div class="card-header text-center bg-dark text-white">List Invitation of Platinum Hotel</div>
                <div class="card-body">
					<div id="no-more-tables">
						<p align="right">
							...
							<?php } ?>
						    <a class="btn btn-success" href="downloadresepsi.php">Download XLSX</a>
					    </p>
